...
const premiumData = {
    ...
    'sabiá-laranjeira': { diet: 'Frutas maduras que caem no chão e pequenos insetos.', habitat: 'Florestas tropicais e cidades brasileiras.', family: 'Turdidae', subspecies: 'Turdus rufiventris.', funFact: 'O canto do sabiá-laranjeira é tão famoso que ele foi escolhido como a ave símbolo do Brasil!', role: 'Ajuda a plantar novas árvores espalhando sementes de frutas pelas florestas.', danger: 'Inofensivo e cantor. Adora cantar no início da manhã.', status: '🟢 Pouco Preocupante' },
    ...
    'quero-quero': { diet: 'Insetos e pequenos invertebrados na grama.', habitat: 'Campos abertos e gramados brasileiros.', family: 'Charadriidae', subspecies: 'Vanellus chilensis.', funFact: 'Eles fazem o ninho no chão da grama e gritam alto "quero-quero!" para defender seus ovos de quem chega perto.', role: 'Funciona como o "alarme" da natureza, avisando outros animais da aproximação de perigo.', danger: 'Observe de longe! Eles podem raspar a asa em você para afastar intrusos.', status: '🟢 Pouco Preocupante' },
    ...
    'arara': { diet: 'Sementes duras, castanhas e frutas silvestres.', habitat: 'Florestas tropicais como Amazônia e Cerrado.', family: 'Psittacidae', subspecies: 'Arara-azul (Anodorhynchus hyacinthinus).', funFact: 'As araras costumam viver em duplas e escolhem um parceiro para a vida inteira!', role: 'Espalha sementes grandes e ajuda a quebrar cascas duras de frutos no chão da mata.', danger: 'Bico muito poderoso. Nunca tente tocar ou alimentar uma arara selvagem.', status: '🟡 Vulnerável (Devido ao tráfico de animais)' },
    ...
    'carcará': { diet: 'Pequenos mamíferos, cobras, carcaças e pequenos répteis.', habitat: 'Áreas abertas, pastagens e beiras de estrada.', family: 'Falconidae', subspecies: 'Caracara plancus.', funFact: 'Ele é um falcão muito esperto que prefere caminhar no chão caçando do que caçar voando alto.', role: 'Ajuda a limpar a natureza comendo restos orgânicos e controlando populações de cobras.', danger: 'Garras fortes de predador. Mantenha distância segura.', status: '🟢 Pouco Preocupante' },
    ...
    'mico': { diet: 'Frutas, sementes, flores e insetos.', habitat: 'Matas brasileiras e áreas de proteção.', family: 'Cebidae', subspecies: 'Mico-estrela (Callithrix penicillata).', funFact: 'Os micos vivem em famílias barulhentas e usam assovios e gritos para se comunicarem na floresta!', role: 'Polinizadores e espalhadores de sementes nas copas das árvores.', danger: 'Deixe-os nas árvores! Eles podem morder se assustados.', status: '🟢 Pouco Preocupante' },
    ...
    'bicho-preguiça': { diet: 'Folhas de árvores como a embaúba.', habitat: 'Copas das árvores na Amazônia e Mata Atlântica.', family: 'Bradypodidae', subspecies: 'Preguiça-de-três-dedos (Bradypus tridactylus).', funFact: 'Elas são os mestres do disfarce! Parecem um graveto de árvore perfeitamente e balançam como se o vento os movesse.', role: 'Fornece um pequeno ecossistema próprio em seus pelos para besouros e traças nativas.', danger: 'Inofensiva, mas tem garras longas para se segurar em galhos.', status: '🟢 Pouco Preocupante' },
    'tamanduá': { diet: 'Cupins e formigas silvestres que encontra em formigueiros.', habitat: 'Florestas tropicais e campos abertos brasileiros.', family: 'Myrmecophagidae', subspecies: 'Tamanduá-bandeira (Myrmecophaga tridactyla).', funFact: 'O tamanduá não tem dentes! Ele usa sua língua super comprida (até 60cm!) e grudenta para comer insetos.', role: 'Mantém o equilíbrio de cupins e formigas na natureza sem destruir os ninhos.', danger: '⚠️ Cuidado: Se ameaçado, ele fica em pé e ataca com suas garras gigantes.', status: '🟡 Vulnerável' },
    ...
    'jaguatirica': { diet: 'Roedores, aves, pequenos lagartos e cobras.', habitat: 'Florestas densas desde a Amazônia até o Sul do país.', family: 'Felidae', subspecies: 'Leopardus pardalis.', funFact: 'Parece uma mini onça-pintada e é uma excelente escaladora de árvores e nadadora noturna.', role: 'Predador de médio porte que ajuda a controlar a população de pequenos roedores silvestres.', danger: '🚨 Carnívoro silvestre. Fique longe e chame um adulto!', status: '🟢 Pouco Preocupante' },
    'lobo-guará': { diet: 'Frutos da lobeira, pequenos mamíferos e aves.', habitat: 'Campos abertos do Cerrado brasileiro.', family: 'Canidae', subspecies: 'Chrysocyon brachyurus.', funFact: 'Apesar de parecer um lobo, ele é muito dócil e adora comer a "fruta-do-lobo", ajudando a espalhar suas sementes.', role: 'Ajuda a plantar a fruta-do-lobo pelo Cerrado, espalhando suas sementes.', danger: 'Tímido e inofensivo para humanos. Não se aproxime para não assustá-lo.', status: '🟡 Vulnerável' },
    'gambá': { diet: 'Frutos, insetos, pequenos roedores, escorpiões e cobras.', habitat: 'Florestas e áreas verdes perto de casas.', family: 'Didelphidae', subspecies: 'Gamba-de-orelha-preta (Saruê).', funFact: 'Os gambás são marsupiais, parentes dos cangurus! As mamães carregam os bebês em uma bolsinha na barriga.', role: 'Controlador biológico fantástico! Eles são imunes ao veneno de cobras e comem escorpiões perigosos.', danger: 'Inofensivo, mas pode soprar forte e fingir de morto se assustado.', status: '🟢 Pouco Preocupante' },
    'quati': { diet: 'Frutas, ovos de aves, lagartixas, insetos e raízes.', habitat: 'Florestas tropicais e parques ecológicos públicos.', family: 'Procyonidae', subspecies: 'Nasua nasua.', funFact: 'Eles andam em grandes bandos familiares com os rabos listrados apontados para cima como antenas!', role: 'Espalham sementes e ajudam a remexer o solo da floresta atrás de insetos.', danger: '⚠️ Dentes e garras muito afiados. Nunca tente tocá-los ou alimentá-los.', status: '🟢 Pouco Preocupante' },
    ...
    'lagartixa': { diet: 'Pequenas aranhas, formigas, moscas e mosquitos.', habitat: 'Paredes e tetos de casas e cascas de árvores.', family: 'Gekkonidae', subspecies: 'Hemidactylus mabouia.', funFact: 'Se pegas pela cauda, as lagartixas conseguem soltá-la para escapar correndo e depois a cauda cresce de novo!', role: 'A maior faxineira das nossas casas, comendo insetos e mosquitos da dengue.', danger: 'Inofensiva e super rápida. Não tente pegá-la!', status: '🟢 Pouco Preocupante' },
    'teiú': { diet: 'Frutas, ovos, insetos e pequenos roedores.', habitat: 'Campos abertos e quintais no Brasil todo.', family: 'Teiidae', subspecies: 'Salvator merianae.', funFact: 'O teiú é o maior lagarto do Brasil, podendo medir até 1,5 metro de comprimento!', role: 'Ajuda a plantar frutas dispersando sementes e consome restos orgânicos.', danger: '⚠️ Silvestre. Se acuado, pode morder ou bater o rabo forte.', status: '🟢 Pouco Preocupante' },
    'iguana': { diet: 'Folhas verdes, flores e frutos jovens.', habitat: 'Copas de árvores perto de lagos e rios nativos.', family: 'Iguanidae', subspecies: 'Iguana iguana.', funFact: 'São ótimas nadadoras! Se assustadas no topo de uma árvore, elas saltam no rio para fugir.', role: 'Consumidor herbívoro nas copas das matas e alimento para aves de rapina.', danger: 'Garras e cauda fortes. Observe apenas à distância.', status: '🟢 Pouco Preocupante' },
    'cobra': { diet: 'Roedores, rãs, ovos e pequenos pássaros.', habitat: 'Florestas densas, gramados e corpos d\'água.', family: 'Boidae (Jiboias/Sucuris) / Viperidae (Jararacas/Cascavéis).', subspecies: 'Jiboia-constritora (Boa constrictor).', funFact: 'As cobras usam a língua bifurcada para "sentir o cheiro" e saber a direção das coisas!', role: 'Controladores indispensáveis de roedores, evitando pragas nos campos e cidades.', danger: '🚨 Algumas cobras têm veneno ativo. Afaste-se e chame um adulto!', status: '🟢 Pouco Preocupante' },
    'tartaruga': { diet: 'Plantas aquáticas, peixes pequenos, algas e frutos.', habitat: 'Lagos, rios e terra firme (Jabutis).', family: 'Testudinidae (Jabutis) / Podocnemididae (Cágados).', subspecies: 'Jabuti-piranga (Chelonoidis carbonarius).', funFact: 'Os jabutis podem viver mais de 80 anos! Eles andam devagar e levam seu próprio casco protetor.', role: 'Dispersa sementes de frutos caídos no chão da mata.', danger: 'Inofensivo. Respeite o casco protetor dele.', status: '🟢 Pouco Preocupante' }
};
...
function getPremiumData(animalName) {
    ...
    else if (cat === 'reptil') { genRole = 'Controladores populacionais de ratos e pequenos mamíferos.'; genDanger = '⚠️ Atenção: Répteis podem se defender com modificações fortes ou veneno. Chame um adulto!'; genStatus = '🟡 Muitas espécies perdem habitat.'; }
